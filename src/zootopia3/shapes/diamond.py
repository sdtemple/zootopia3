...
class Diamond:
    def __init__(self, diagonal_h: int, diagonal_v: int, rgb_color: tuple, rgb_name: str):
    ...
    def __repr__(self) -> str:
        return f"Diamond(diagonal_h={self.diagonal_h}, diagonal_v={self.diagonal_v}, rgb_color={self.rgb_color}, rgb_name='{self.rgb_name}')"
    def __str__(self) -> str:
        return f"Diamond of horizontal diagonal {self.diagonal_h}, vertical diagonal {self.diagonal_v} with color {self.rgb_name} ({self.rgb_color})"
